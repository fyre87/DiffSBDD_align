...
# Notes: This creates a LigandPocketDDPM object from "lightning_modules.py"
# That object stores a ConditionalDDPM from "conditional_modeling.py"
...
if __name__ == "__main__":
    ...
    # Load original model
    pl_module = LigandPocketDDPM.load_from_checkpoint("checkpoints/moad_fullatom_cond.ckpt", map_location=args.egnn_params.device)
    pl_module.datadir = args.datadir
    pl_module.batch_size = args.batch_size
    pl_module.lr = args.lr
    # Load reference model
    pl_module.ref_model = LigandPocketDDPM.load_from_checkpoint("checkpoints/moad_fullatom_cond.ckpt", map_location=args.egnn_params.device)
    # print("*****NORMAL MODEL*****")
    # print(pl_module.print_params())
    # print("*****REF MODEL*****")
    # print(pl_module.ref_model.print_params())
    ...
    # trainer.fit(model=pl_module, ckpt_path="checkpoints/moad_fullatom_align.ckpt")
    trainer.save_checkpoint("checkpoints/moad_fullatom_align_2.ckpt")
